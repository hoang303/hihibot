...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["bạn gọi tôi có việc gì?", "tôi yêu bạn vai lon", "Yêu em <3", "Hi, chào con vợ bé:3", "Vợ gọi có việc gì không?", "Sử dụng callad để liên lạc với admin!", "Em là bot cute nhất hành tinh", "Nói gì thế con lợn", "Em đây~~~~", "Yêu anh admin nhất", "chị ấy là bae của admin", "Yêu thương admin nhất", "Sao thế công chúa", "Làm ny admin em ko ạ? dui lắm", "Được của ló :)))", "Em dthw như chủ của em ạ", "Đừng khen em ngại quá hí hí" ,"Làm vợ admin em ko ạ?", "Đừng spam em nha :<<, cậu chủ em mệt lắm ời", "Đừng để em nóng!!!", "Spam tutu thôi em lag :'(", "Chồng em đây rồi"];
  ...
  if ((event.body.toLowerCase() == "ơi") || (event.body.toLowerCase() == "oi")) {
    return api.sendMessage("Ngoan đấy tặng cậu cây kẹo :)", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao Phan Huyy có gì dùng lệnh /adbot admin để biết thêm chi tiết", threadID);
  };
